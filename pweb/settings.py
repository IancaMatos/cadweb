...
DATABASES = {
   'default': dj_database_url.parse('postgresql://neondb_owner:npg_L0heGSTvo3wN@ep-dry-butterfly-ac6a13hy-pooler.sa-east-1.aws.neon.tech/neondb?sslmode=require')
}
